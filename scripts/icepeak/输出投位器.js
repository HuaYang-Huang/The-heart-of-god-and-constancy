...
const blockType = extend(StorageBlock, "输出投位器", {
    load() {
        this.super$load();
        topRegion = lib.loadRegion("输出投位器-top");
        bottomRegion = lib.loadRegion("输出投位器-bottom");
        rotatorRegion = lib.loadRegion("输出投位器-rotator");
    },
    init() {
        this.super$init();
